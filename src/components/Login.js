    ...
    return (
      ...
      <div className="login-form-two">
        ...
        <form onSubmit={this.formSubmit}>
          ...
          <input className="input-style" type='text' name='username' placeholder="Username e.g. IronhackFTWD" value={this.state.username} onChange={e => this.changeTheInputText(e)} /><br />
          </div>

          <div className="inputAndLabelHolder">
          <input className="input-style" type='password' name='password' placeholder="Input Password" value={this.state.password} onChange={e => this.changeTheInputText(e)} />
          </div>
